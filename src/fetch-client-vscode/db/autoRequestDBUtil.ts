import { Auto_Repository_SaveAutoRequests, Auto_Repository_GetAllAutoRequests, Auto_Repository_GetAutoRequestById } from '../../fetch-client-core/db/autoRequest.repository';
...
export async function GetAllAutoRequest(
...
export async function GetAutoRequestById(
	id: string,
	webview: vscode.Webview
) {
	try {
