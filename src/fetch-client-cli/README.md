...
Fetch Client CLI is the official command-line interface for the [**Fetch Client**](https://marketplace.visualstudio.com/items?itemName=GanesanChandran.fetch-client) VS Code extension. It allows you to execute requests, collections, and folders
without opening VS Code, making it ideal for automation, CI/CD pipelines, and scripting.
