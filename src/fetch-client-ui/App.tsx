...
const CopyTo = React.lazy(
	() => import("./components/Collection/CopyTo/copyTo"),
);
const Variables = React.lazy(() => import("./components/Variables"));
const AttachVariable = React.lazy(
	() => import("./components/Collection/AttachVariable/attachVariable"),
);
const ManageCookies = React.lazy(() => import("./components/Cookies"));
const CollectionSettings = React.lazy(
	() => import("./components/Collection/Settings/CollectionSettings"),
);
const RunAll = React.lazy(
	() => import("./components/Collection/RunAll/runAll"),
);
const ErrorLog = React.lazy(() => import("./components/ErrorLog/ErrorLog"));
const CurlUI = React.lazy(() => import("./components/Curl"));
const BulkExportUI = React.lazy(
	() => import("./components/Collection/BulkExport/bulkExport"),
);
const AutoRequestUI = React.lazy(() => import("./components/AutoRequest"));
const ReOrder = React.lazy(
	() => import("./components/Collection/ReOrder/reorder"),
);
...
function ErrorFallback({ error }) {
	...
	return (
		<div className="error-panel">
			<input
				className="error-something-text-box"
				type="text"
				value="💥💥 Something went wrong 💥💥"
			></input>
			<textarea
				className="error-header-text-box"
			...
			<div className="issue-raise-button-panel">
				<a
					href="https://github.com/Ganesan-Chandran/vscode-fetch-client/issues/new/choose"
					className="request-send-button issue-raise-button"
				>
					Raise Issue
				</a>
			</div>
