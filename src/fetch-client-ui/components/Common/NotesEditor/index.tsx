...
export const NotesEditor = () => {
	...
	useEffect(() => {
		...
		const htmlFormatElement = document.querySelector(
	...
	return (
		<div className="notes-editor-panel">
			...
			<div
				className={
					count > notesMaxLimit ? "error-text notes-text" : "notes-text"
				}
			>
				{count}/{notesMaxLimit}{" "}
				{count > notesMaxLimit
					? " (Exceed the maximum character limit. Notes won't be saved.)"
					: ""}
			</div>
		</div>
	);
