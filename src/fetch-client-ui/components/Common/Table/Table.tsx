...
import { dataTypes, HeadersKeys, HerdersValues, ITableData, TableType } from "./types";
...
export const Table = (props: TableProps) => {
  const { data, onSelectChange, onSelectType, onFileSelect, onRowAdd, onRowUpdate, deleteData, readOnly, selectedVariable } = props;
  ...
  function getFileSelectColumn(row: ITableData, index: number) {
    return (
      <>
        <button className="file-select" onClick={(e) => fileSelect(index)}>Select</button>
