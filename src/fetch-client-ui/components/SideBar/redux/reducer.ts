...
export const SideBarReducer: (
	...
	action: SideBarActionTypes = {} as SideBarActionTypes,
): ISideBarModel => {
	switch (action.type) {
		...
		case FETCH_CLIENT_SET_RENAME_HISTORY: {
			return {
				...state,
				history: renameHistoryFromState(
					action.payload.id,
					action.payload.name,
					state.history,
				),
		...
		case FETCH_CLIENT_SET_NEW_HISTORY_TO_COLLECTION: {
			return {
				...state,
				collections: appendToCollectionState(
		...
		case FETCH_CLIENT_SET_DELETE_COL_ITEM: {
			return {
				...state,
				collections: deleteColItemFromState(
					action.payload.colId,
					action.payload.folderId,
					action.payload.historyId,
					action.payload.isFolder,
		...
		case FETCH_CLIENT_SET_RENAME_COLLECTION: {
			return {
				...state,
				collections: renameCollectionFromState(
					action.payload.colId,
					action.payload.name,
					state.collections,
				),
		...
		case FETCH_CLIENT_SET_DELETE_COLLECTION: {
			return {
				...state,
				collections: deleteCollectionFromState(
					action.payload.colId,
					state.collections,
				),
			};
		...
		case FETCH_CLIENT_SET_COPY_TO_COLLECTION: {
			return {
				...state,
				collections: copyToCollectionToState(
					action.payload.collection,
					state.collections,
				),
			};
		...
		case FETCH_CLIENT_SET_ATTACH_DETACH_VARIABLE: {
			return {
				...state,
				collections: attachVariableFromState(
					action.payload.colId,
					action.payload.varId,
					state.collections,
				),
		...
		case FETCH_CLIENT_SET_ACTIVE_INACTIVE_VARIABLE: {
			return {
				...state,
				variable: updateStatusVariableFromState(
					action.payload.varId,
		...
		case FETCH_CLIENT_SET_NEW_REQUEST_TO_COLLECTION: {
			return {
				...state,
				collections: appendRequestToCollectionState(
					action.payload.item,
					action.payload.id,
					action.payload.folId,
					state.collections,
				),
			};
		}
		...
		case FETCH_CLIENT_SET_UPDATE_COLLECTION_ITEM: {
			return {
				...state,
				collections: updateItemInCollectionState(
					action.payload.item,
					action.payload.colId,
					state.collections,
				),
		...
		case FETCH_CLIENT_SET_UPDATE_HISTORY_ITEM: {
			return {
				...state,
				history: updateItemInHistoryState(action.payload.item, [
					...state.history,
				]),
			};
		}
...
function renameHistoryFromState(
	id: string,
	name: string,
	history: IHistory[],
): IHistory[] {
...
function findItemById(
	id: string,
	items: IHistory[] | ICollections[] | IVariable[],
): { found: boolean; index: number } {
	let findIndex: number = -1;
	let found = items.some(function (
		item: IHistory | ICollections | IVariable,
		index: number,
	) {
		findIndex = index;
		return item.id === id;
...
function appendToCollectionState(
	item: ICollections,
	cols: ICollections[],
): ICollections[] {
...
function renameColItemFromState(
	colId: string,
	folderId: string,
	historyId: string,
	name: string,
...
function deleteColItemFromState(
	colId: string,
	folderId: string,
	historyId: string,
	isFolder: boolean,
...
function renameCollectionFromState(
	id: string,
	name: string,
	cols: ICollections[],
): ICollections[] {
...
function deleteCollectionFromState(
	id: string,
	cols: ICollections[],
): ICollections[] {
	const { found, index } = findItemById(id, cols);
...
function clearCollectionFromState(
	id: string,
	folderId: string,
	cols: ICollections[],
): ICollections[] {
...
function importCollectionToState(
	item: ICollections,
	cols: ICollections[],
): ICollections[] {
...
function copyToCollectionToState(
	item: ICollections,
	cols: ICollections[],
): ICollections[] {
	const { found, index } = findItemById(item.id, cols);
...
function renameVariableFromState(
	id: string,
	name: string,
	vars: IVariable[],
): IVariable[] {
...
function attachVariableFromState(
	colId: string,
	varId: string,
	cols: ICollections[],
): ICollections[] {
...
function updateStatusVariableFromState(
	_id: string,
	status: boolean,
	vars: IVariable[],
): IVariable[] {
...
function appendRequestToCollectionState(
...
function updateItemInCollectionState(
	item: IHistory,
	colId: string,
	cols: ICollections[],
): ICollections[] {
...
function updateItemInHistoryState(
	item: IHistory,
	items: IHistory[],
): IHistory[] {
