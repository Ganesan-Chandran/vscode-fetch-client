import {
  ...
  FETCH_CLIENT_SET_HISTORY, FETCH_CLIENT_SET_IMPORT_COLLECTION, FETCH_CLIENT_SET_NEW_HISTORY, FETCH_CLIENT_SET_NEW_HISTORY_TO_COLLECTION, FETCH_CLIENT_SET_NEW_REQUEST_TO_COLLECTION, FETCH_CLIENT_SET_NEW_VARIABLE, FETCH_CLIENT_SET_RENAME_COLLECTION, FETCH_CLIENT_SET_RENAME_COL_ITEM, FETCH_CLIENT_SET_RENAME_HISTORY,
  FETCH_CLIENT_SET_RENAME_VARIABLE,
  FETCH_CLIENT_SET_UPDATE_VARIABLE,
  FETCH_CLIENT_SET_VARIABLE,
  ICollections, IHistory, IVariable, SideBarActionTypes
} from "./types";
...
export const SetRenameColItemAction = (value: string, value1: string, value2: string): SideBarActionTypes => {
  return {
...
export const SetDeleteColItemAction = (value: string, value1: string): SideBarActionTypes => {
  return {
...
export const SetClearCollectionAction = (value: string): SideBarActionTypes => {
  return {
...
export const SetNewRequestToCollectionAction = (value: IHistory, value1: string): SideBarActionTypes => {
  return {
