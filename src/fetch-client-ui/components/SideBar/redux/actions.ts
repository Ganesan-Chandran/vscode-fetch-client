...
export const SetHistoryToCollectionAction = (
	value: ICollections,
): SideBarActionTypes => {
	return {
...
export const SetRenameHistoryAction = (
	value: string,
	value1: string,
): SideBarActionTypes => {
	return {
...
export const SetCollectionAction = (
	value: ICollections[],
): SideBarActionTypes => {
	return {
...
export const SetRenameColItemAction = (
	value: string,
	value1: string,
	value2: string,
	value3: boolean,
...
export const SetDeleteColItemAction = (
	value: string,
	value1: string,
	value2: string,
	value3: boolean,
...
export const SetRenameCollectionAction = (
	value: string,
	value1: string,
): SideBarActionTypes => {
	return {
...
export const SetDeleteCollectionAction = (
	value: string,
): SideBarActionTypes => {
	return {
...
export const SetClearCollectionAction = (
	value: string,
	value1: string,
): SideBarActionTypes => {
	return {
...
export const SetImportCollectionAction = (
	value: ICollections,
): SideBarActionTypes => {
	return {
...
export const SetCopyToCollectionAction = (
	value: ICollections,
): SideBarActionTypes => {
	return {
...
export const SetRenameVariableAction = (
	value: string,
	value1: string,
): SideBarActionTypes => {
	return {
...
export const SetAttachVariableAction = (
	value: string,
	value1: string,
): SideBarActionTypes => {
	return {
...
export const SetActiveVariableAction = (
	value: string,
	value1: boolean,
): SideBarActionTypes => {
	return {
...
export const SetNewRequestToCollectionAction = (
	value: IHistory,
	value1: string,
	value2: string,
): SideBarActionTypes => {
...
export const SetFolderToCollectionAction = (
	value: IFolder,
	value1: string,
	value2: string,
): SideBarActionTypes => {
...
export const SetUpdateCollectionItemAction = (
	value: IHistory,
	value1: string,
): SideBarActionTypes => {
	return {
...
export const SetUpdateHistoryItemAction = (
	value: IHistory,
): SideBarActionTypes => {
	return {
