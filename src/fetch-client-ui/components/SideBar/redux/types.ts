...
export const FETCH_CLIENT_SET_COLLECTION: "FETCH_CLIENT_SET_COLLECTION" =
	"FETCH_CLIENT_SET_COLLECTION";
export const FETCH_CLIENT_SET_DELETE_HISTORY: "FETCH_CLIENT_SET_DELETE_HISTORY" =
	"FETCH_CLIENT_SET_DELETE_HISTORY";
export const FETCH_CLIENT_SET_RENAME_HISTORY: "FETCH_CLIENT_SET_RENAME_HISTORY" =
	"FETCH_CLIENT_SET_RENAME_HISTORY";
export const FETCH_CLIENT_SET_NEW_HISTORY: "FETCH_CLIENT_SET_NEW_HISTORY" =
	"FETCH_CLIENT_SET_NEW_HISTORY";
export const FETCH_CLIENT_SET_NEW_HISTORY_TO_COLLECTION: "FETCH_CLIENT_SET_NEW_HISTORY_TO_COLLECTION" =
	"FETCH_CLIENT_SET_NEW_HISTORY_TO_COLLECTION";
export const FETCH_CLIENT_SET_RENAME_COL_ITEM: "FETCH_CLIENT_SET_RENAME_COL_ITEM" =
	"FETCH_CLIENT_SET_RENAME_COL_ITEM";
export const FETCH_CLIENT_SET_DELETE_COL_ITEM: "FETCH_CLIENT_SET_DELETE_COL_ITEM" =
	"FETCH_CLIENT_SET_DELETE_COL_ITEM";
export const FETCH_CLIENT_SET_RENAME_COLLECTION: "FETCH_CLIENT_SET_RENAME_COLLECTION" =
	"FETCH_CLIENT_SET_RENAME_COLLECTION";
export const FETCH_CLIENT_SET_DELETE_COLLECTION: "FETCH_CLIENT_SET_DELETE_COLLECTION" =
	"FETCH_CLIENT_SET_DELETE_COLLECTION";
export const FETCH_CLIENT_SET_CLEAR_COLLECTION: "FETCH_CLIENT_SET_CLEAR_COLLECTION" =
	"FETCH_CLIENT_SET_CLEAR_COLLECTION";
export const FETCH_CLIENT_SET_IMPORT_COLLECTION: "FETCH_CLIENT_SET_IMPORT_COLLECTION" =
	"FETCH_CLIENT_SET_IMPORT_COLLECTION";
export const FETCH_CLIENT_SET_COPY_TO_COLLECTION: "FETCH_CLIENT_SET_COPY_TO_COLLECTION" =
	"FETCH_CLIENT_SET_COPY_TO_COLLECTION";
export const FETCH_CLIENT_SET_VARIABLE: "FETCH_CLIENT_SET_VARIABLE" =
	"FETCH_CLIENT_SET_VARIABLE";
export const FETCH_CLIENT_SET_DELETE_VARIABLE: "FETCH_CLIENT_SET_DELETE_VARIABLE" =
	"FETCH_CLIENT_SET_DELETE_VARIABLE";
export const FETCH_CLIENT_SET_RENAME_VARIABLE: "FETCH_CLIENT_SET_RENAME_VARIABLE" =
	"FETCH_CLIENT_SET_RENAME_VARIABLE";
export const FETCH_CLIENT_SET_NEW_VARIABLE: "FETCH_CLIENT_SET_NEW_VARIABLE" =
	"FETCH_CLIENT_SET_NEW_VARIABLE";
export const FETCH_CLIENT_SET_UPDATE_VARIABLE: "FETCH_CLIENT_SET_UPDATE_VARIABLE" =
	"FETCH_CLIENT_SET_UPDATE_VARIABLE";
export const FETCH_CLIENT_SET_ATTACH_DETACH_VARIABLE: "FETCH_CLIENT_SET_ATTACH_DETACH_VARIABLE" =
	"FETCH_CLIENT_SET_ATTACH_DETACH_VARIABLE";
export const FETCH_CLIENT_SET_ACTIVE_INACTIVE_VARIABLE: "FETCH_CLIENT_SET_ACTIVE_INACTIVE_VARIABLE" =
	"FETCH_CLIENT_SET_ACTIVE_INACTIVE_VARIABLE";
export const FETCH_CLIENT_SET_NEW_REQUEST_TO_COLLECTION: "FETCH_CLIENT_SET_NEW_REQUEST_TO_COLLECTION" =
	"FETCH_CLIENT_SET_NEW_REQUEST_TO_COLLECTION";
export const FETCH_CLIENT_SET_NEW_FOLDER_TO_COLLECTION: "FETCH_CLIENT_SET_NEW_FOLDER_TO_COLLECTION" =
	"FETCH_CLIENT_SET_NEW_FOLDER_TO_COLLECTION";
export const FETCH_CLIENT_SET_UPDATE_COLLECTION_ITEM: "FETCH_CLIENT_SET_UPDATE_COLLECTION_ITEM" =
...
export type SideBarActionTypes =
	...
	| ISetRenameHistory
	| ISetNewHistory
	| ISetHistoryToCollection
	| ISetRenameColItem
	| ISetDeleteColItem
	| ISetRenameCollection
	| ISetDeleteCollection
	| ISetClearCollection
	| ISetImportCollection
	| ISetCopyToCollection
	| ISetVariable
	| ISetDeleteVariable
	| ISetRenameVariable
	| ISetNewVariable
