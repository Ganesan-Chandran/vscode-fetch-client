import { Base64Encoder, JwtDecoder, UrlEncoder } from "./encoding";
import {
	JsonFormatter,
	JsonPathTester,
	JsonSchemaGenerator,
...
import { QueryStringParser, UrlParser } from "./apiTools";
import { HashGenerator, HmacGenerator, JwtGenerator } from "./securityTools";
...
export const devTools: IDevTool[] = [
	{
		...
		category: "encoding",
		description: "Encode and decode URL values",
	...
	},
	{
		...
		category: "json",
		description: "Generate a basic JSON Schema",
...

	{
		...
		category: "generators",
		description: "Generate UUID v1, v4 and v7",
	...
	},
	{
		...
		category: "generators",
		description: "Generate API test data",
	...
	},
	{
		...
		title: "JWT Generator",
		category: "security",
		description: "Generate unsigned JWTs",
