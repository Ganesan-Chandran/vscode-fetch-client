export const FETCH_CLIENT_SET_ACC_OPEN: "FETCH_CLIENT_SET_ACC_OPEN" =
	"FETCH_CLIENT_SET_ACC_OPEN";
export const FETCH_CLIENT_SET_UI_HORIZONTAL: "FETCH_CLIENT_SET_UI_HORIZONTAL" =
	"FETCH_CLIENT_SET_UI_HORIZONTAL";
export const FETCH_CLIENT_SET_UI_THEME: "FETCH_CLIENT_SET_UI_THEME" =
	"FETCH_CLIENT_SET_UI_THEME";
export const FETCH_CLIENT_SET_RUN_ITEM: "FETCH_CLIENT_SET_RUN_ITEM" =
	"FETCH_CLIENT_SET_RUN_ITEM";
export const FETCH_CLIENT_SET_RESPONSE_LIMIT: "FETCH_CLIENT_SET_RESPONSE_LIMIT" =
