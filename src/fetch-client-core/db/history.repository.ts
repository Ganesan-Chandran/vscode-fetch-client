...
export async function History_Repository_InsertHistory(item: IHistory): Promise<void> {
...
export async function History_Repository_UpdateHistory(item: IHistory): Promise<boolean> {
  const db = await getHistoryDB();
...
export async function History_Repository_GetHistoryById(id: string): Promise<IHistory[]> {
  const db = await getHistoryDB();
...
export async function History_Repository_DeleteHistory(id: string): Promise<void> {
  const db = await getHistoryDB();
