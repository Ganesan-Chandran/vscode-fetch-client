...
module.exports = (webpackEnv = "production") => ({
	...
	devtool:
		webpackEnv === "production" ? "source-map" : "eval-cheap-module-source-map",
	...
	resolve: {
		extensions: [".ts", ".js"],
		alias: {
			vscode: path.resolve(__dirname, "src/fetch-client-cli/stubs/vscode.ts"),
			[path.resolve(__dirname, "src/extension.ts")]: path.resolve(
				__dirname,
